...
namespace LeeVox.Sdk
{
    internal interface IRandom
    {
        ...
        /// <summary>
        /// Returns a random UTF-16 string with a specified length.
        /// </summary>
        /// <param name="length">Length of the output string.</param>
        /// <returns>
        /// A sequence of UTF-16 characters which are greater than or equal to <see cref="char.MinValue"/>, and less than <see cref="char.MaxValue"/>.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="length"/> is less than <c>0</c>.</exception>
