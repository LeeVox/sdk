...
namespace LeeVox.Sdk.Test
{
    ...
    public class StringParseExtensionTests
    {
        ...
        public void ParseToPrimitiveTypeTests()
        {
            ...
            Assert.AreEqual(new DateTime(2018, 11, 26, 1, 23, 45, 666, DateTimeKind.Utc).ToLocalTime(), "2018-11-26 01:23:45.666".ParseToDateTime(null, DateTimeStyles.AssumeUniversal));
            Assert.AreEqual(new DateTime(2018, 11, 26, 1, 23, 45, 666), "2018-11-26 01:23:45.666".ParseToDateTime(null, DateTimeStyles.AssumeLocal));
            Assert.AreEqual(new DateTime(1970, 1, 1), "YYYY/MM/DD".ParseToDateTime(null, DateTimeStyles.AssumeLocal, new DateTime(1970, 1, 1)));
